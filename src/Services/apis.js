...
export const endpoints = {
<<<<<<< HEAD
  SIGNUP_API:   "http://localhost:3000/api/v2/auth/signup",
  LOGIN_API:   "http://localhost:3000/api/v2/auth/login",
  PROFILE_API: "http://localhost:3000/api/v2/userdetail/userDetail",
  SUBMISSION_API: "http://localhost:3000/api/v2/submission",
  UPDATE_API: "http://localhost:3000/api/v2/profile/updateProfile",
  LOGOUT_API: "http://localhost:3000/api/v2/auth/logout",
}
||||||| 870fc9b
  SIGNUP_API:   "https://server-qcrx.onrender.com/api/v2/auth/signup",
  LOGIN_API:   "https://server-qcrx.onrender.com/api/v2/auth/login",
...
>>>>>>> 174d85f36403d09d15d4fdb46a23a73c5c3f1bb5
